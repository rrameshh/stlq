...
from networks.resnet import resnet18, BasicBlock
from ops import QuantizedOperator, QuantizedConv2dBatchNorm2dReLU
...
class CIFAR10ResNet(nn.Module):
    def __init__(self, device, stlq_ratio=0.1):
        ...
        model.conv1 = QuantizedConv2dBatchNorm2dReLU(
