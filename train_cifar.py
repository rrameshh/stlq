...
#                 if hasattr(module, 'running_max_abs'):
#                     print(f"{name:30} | running_max={module.running_max_abs.item():.6f}")
...
#             print(f"{name:30} | config_id={id(module.config)} | thresh={module.config.threshold}")
